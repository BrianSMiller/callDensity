...
### a) Assign NL to each call from plausible distribution of NL:

NL: mean= 90, sd=4 dB re 1 uPa

```{r sonar.eq.SL.NL}

SL <- data.frame(mean=190, sd=8, sampleSize=350)
...
### b) Assign TL to each call using spherical spreading propagation model:
...
Table showing the results of each call density estimate.
