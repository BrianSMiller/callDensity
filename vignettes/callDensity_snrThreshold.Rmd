...
SNRinfo <- chtToSNRinfo(capHistTab, groundTruth = "table1", observers = "table2", timeCol = "t")
SNRinfot<- chtToSNRinfo(capHistTabt, groundTruth = "table1", observers = "table2", timeCol = "t")
...
cr.none <- cde(Nc = Nc, capHistTab = capHistTab, snrDetFun = snrDetFun.vglmNone,
               ...
               groundTruthCol = "groundTruth2", observerCol = "detect_table2")
