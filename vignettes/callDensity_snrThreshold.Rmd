...
nTrueDetectedSubset <- with(capHistTab,sum(detect_observer1 & groundTruth1 |   
                                        detect_observer2 & groundTruth2) )
nTrueDetectedSubsett <- with(capHistTabt,sum(detect_observer1 & groundTruth1 |   
                                        detect_observer2 & groundTruth2) )
...
nPositiveSubsett <- with(capHistTabt,sum(detect_observer1 | detect_observer2))
...
SNRinfot<- chtToSNRinfo(capHistTabt, groundTruth = "observer1", observers = "observer2", timeCol = "t")

# Detector 2 true & false positives
n_p_subsampleDet2 <- sum(capHistTab$detect_observer2)
n_p_subsampleDet2t <- sum(capHistTabt$detect_observer2) 
...
n_fp_subsamplet <- sum(capHistTabt$detect_observer2 & !capHistTabt$detect_observer1)
...
runCell <- function(theta, det1scale, seed, n = 5e4, outerloop = 10) {
  ...
  fit <- fitSNRvglm(adj, c("detect_observer1", "detect_observer2"),
                    whichObserver = "detect_observer2")
