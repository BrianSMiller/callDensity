---
title: "Non-uniform study areas: distance truncation and coastlines"
output: 
  rmarkdown::html_vignette:
    vignette: >
      %\VignetteEncoding{UTF-8}
      %\VignetteIndexEntry{Non-uniform study areas: distance truncation and coastlines}
...
# Best estimate of NL 
NLadj <- nlFromSnrInfo(chtToSNRinfo(capHistTab, groundTruth = "table1", observers = "table2", timeCol = "t"), snrDetFun.vglm)
