...
###################### STEP 1(a) - Thin TL data ################################
  ...
  for (i in 1:outerloop){
    ...
    #***************************************************************************
    ## STEP 3(b) - bootstrap from the assumed noise distribuation and ####
    #calculate new mean and standard deviation. The number of samples in the
    #bootstrap reflects the sample size used to create the original distribution
    ...
    #***************************************************************************
    ## STEP 3(c) - produce a random realisation of the detector  ####
    ...
    #***************************************************************************
    ## STEP 4(a) draw 10000 values from the generated SL distribution ##########
    ...
    #***************************************************************************
    ## STEPS 4(c) and 4(d) calculate SNR across the whole matrix (all 8 ####
    #profiles) calculate SNR across the whole matrix (all 8 profiles)
    allSNR<- allSL-allTLsubset-allNL
    #***************************************************************************
    ## STEP 4(e): now for each profile, calculate predicted p(dets) ##########
    # for each range
