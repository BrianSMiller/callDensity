...
ch_scam <- capHistTab
ch_scam$detect_observer1 <- as.logical(ch_scam$groundTruth1)
ch_scam$detect_observer2 <- as.logical(ch_scam$detect_observer2)
ch_scam$snr_observer2 <- ch_scam$snr2
ch_scam$signalRMSdB_observer2 <- ch_scam$signalRMSdB2
ch_scam$noiseRMSdB_observer2 <- ch_scam$noiseRMSdB2

# Fit scam detection function
SNRinfo_scam <- chtToSNRinfo(ch_scam, groundTruth = "observer1", observers = "observer2", timeCol = "t")
...
ch_vglm$detect_observer2 <- as.logical(ch_vglm$detect_observer2)
ch_vglm$snr_observer2 <- ch_vglm$snr2
ch_vglm$signalRMSdB_observer2 <- ch_vglm$signalRMSdB2
ch_vglm$noiseRMSdB_observer2 <- ch_vglm$noiseRMSdB2
